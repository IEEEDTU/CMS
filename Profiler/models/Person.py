...
class Person(models.Model):
    ...
    # Permanent Address
    permanentAdd = models.ForeignKey(Address, related_name="%(class)s_permanent_address", on_delete=models.CASCADE,
                                     default=False)
    # Present Address
    presentAdd = models.ForeignKey(Address, related_name="%(class)s_present_address", on_delete=models.CASCADE,
                                   default=False)
    # Guardian Address
    guardianAdd = models.ForeignKey(Address, related_name="%(class)s_guardian_address", on_delete=models.CASCADE,
                                    default=False)
    # Personal Contact Number
    personalMobile = models.ForeignKey(Mobile, related_name="%(class)s_personal_mobile", on_delete=models.CASCADE,
                                       default=False)
    # Alternative Contact Number
    alternativeMobile = models.ForeignKey(Mobile, related_name="%(class)s_alternative_mobile", on_delete=models.CASCADE,
                                          default=False)
